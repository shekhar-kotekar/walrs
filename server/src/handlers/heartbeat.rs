...
//             match commons::read_from_socket::<PeerResponse>(&mut stream).await {
...
//         let mut self_info = NodeInfo::new();
//         self_info.registed_topics.push("test_topic".to_string());
//         cluster_info.add_node(self_address.clone(), self_info);

//         let remote_address = "127.0.0.1:8081".to_string();
//         cluster_info.add_node(remote_address.clone(), NodeInfo::new());
